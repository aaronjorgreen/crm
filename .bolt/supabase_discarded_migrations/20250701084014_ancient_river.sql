/*
  # Complete CRM Schema Migration - Final Version

  1. New Tables
    - `user_profiles` - User profile information with roles and preferences
    ...
    - `client_communications` - Client communication history
    - `client_assignments` - AI-powered client assignments
    - `projects` - Project management
    - `project_members` - Project team members
    - `tasks` - Task management
    - `task_comments` - Task comments
    - `invoices` - Invoice management
    - `ai_extractions` - AI data extraction results

  2. Security
    - Enable RLS on all tables
    - Add comprehensive policies for workspace-based access control
    - Admin and super admin override policies
